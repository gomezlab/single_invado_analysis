...
3T3 fibroblasts. We also show how a single point mutation in Paxillin at the
Jun-kinase phosporylation site Serine 178 changes focal adhesion size,
...
dynamically regulated in living cells.
...
of focal adhesion distribution, morphology, and turnover in migrating NIH 3T3
...
We used TIRF microscopy and a set of computational algorithms to identify and
track FA in order to quantify the static and dynamic properties of FAs (Figure
\ref{method_flow}). 
...
in 5\% CO2 at 37°C in Dulbecco’s modified Eagle’s medium (DMEM, Mediatech)
...
media). Cells were simultaneously infected with virus containing myr-mRFP and
...
Fibronectin (Sigma) for 30min. Fibroblasts expressing EGFP- Pax$_{\text{S187A}}$
...
The cell edges were found using a described in a prior publication
\cite{Machacek06}, with some modifications. 
...
that adhesion in terms of the euclidian distance between each adhesion's
