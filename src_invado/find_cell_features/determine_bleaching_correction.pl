...
# Main Program
################################################################################
my @matlab_code = ("determine_bleaching_correction('$cfg{individual_results_folder}')\n");

$opt{error_folder} = catdir($cfg{exp_results_folder}, $cfg{errors_folder}, 'bleaching_correction');
